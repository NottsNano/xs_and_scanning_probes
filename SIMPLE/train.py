...
from SIMPLE.utils.callbacks import SelfPlayCallback
from SIMPLE.utils.files import reset_files
from SIMPLE.utils.register import get_network_arch, get_environment
...
def main(args):
  ...
  model_dir = os.path.join(SIMPLE.config.MODELDIR, args.env_name)
